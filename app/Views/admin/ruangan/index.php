        ...
        <div class="col-md-10">
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2><i class="bi bi-door-open"></i> Data Ruangan</h2>
                        <p class="text-muted mb-0">Total: <strong><?= $total ?></strong> ruangan</p>
                    </div>
                    <div>
                        <a href="<?= base_url('admin/ruangan') ?>" class="btn btn-secondary me-2">
                            <i class="bi bi-arrow-clockwise"></i> Refresh
                        </a>
                        <a href="<?= base_url('admin/ruangan/create') ?>" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/ruangan/edit/'.$r['id_ruangan']) ?>" 
                                                   class="btn btn-sm btn-warning me-1">
                                                    <i class="bi bi-pencil"></i> Edit
                                                </a>
                                                <a href="<?= base_url('admin/ruangan/delete/'.$r['id_ruangan']) ?>" 
                                                   class="btn btn-sm btn-danger" 
                                                   onclick="return confirm('Yakin ingin menghapus ruangan <?= $r['nama_ruangan'] ?>?')">
