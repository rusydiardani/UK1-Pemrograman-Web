                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Total: <strong><?= $total ?></strong> mahasiswa
                    ...
                    <div>
                        <a href="<?= base_url('admin/mahasiswa') ?>" class="btn btn-secondary me-2">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $mhs['nama'] ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/mahasiswa/edit/'.$mhs['nim']) ?>" 
                                                   class="btn btn-sm btn-warning me-1">
                                                    <i class="bi bi-pencil"></i> Edit
                                                </a>
                                                <a href="<?= base_url('admin/mahasiswa/delete/'.$mhs['nim']) ?>" 
                                                   class="btn btn-sm btn-danger" 
                                                   onclick="return confirm('Yakin ingin menghapus mahasiswa <?= $mhs['nama'] ?>?')">
